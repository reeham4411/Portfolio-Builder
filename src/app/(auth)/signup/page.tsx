    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{ background: "var(--accent-2)", filter: "blur(120px)" }}
        />
      </div>
            ...
            <>
              <div className="mb-6">
                ...
                <p className="text-(--text-muted) text-sm">
                  Start building your portfolio in minutes. No password
                  required.
                </p>
              </div>
              ...
              <div className="space-y-2 mb-6">
                {[
                  "Build a stunning portfolio in 3 minutes",
                  "AI writes your bio and descriptions",
                  "One-click publish with a shareable link",
                ].map((item) => (
                  <div
                    key={item}
